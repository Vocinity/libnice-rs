...
impl Agent {
    ...
    pub fn generate_local_candidate_sdp(&self, candidate: &mut Candidate) -> glib::GString {
        unsafe {
    ...
    pub fn generate_local_sdp(&self) -> glib::GString {
        unsafe {
    ...
    pub fn generate_local_stream_sdp(&self, stream_id: u32, include_non_ice: bool) -> glib::GString {
        unsafe {
    ...
    pub fn default_local_candidate(&self, stream_id: u32, component_id: u32) -> Candidate {
        unsafe {
    ...
    pub fn io_stream(&self, stream_id: u32, component_id: u32) -> gio::IOStream {
        unsafe {
    ...
    pub fn stream_name(&self, stream_id: u32) -> glib::GString {
        unsafe {
    ...
    pub fn parse_remote_candidate_sdp(&self, stream_id: u32, sdp: &str) -> Candidate {
        unsafe {
    ...
    //pub fn recv_messages(&self, stream_id: u32, component_id: u32, messages: /*Ignored*/Vec<InputMessage>, cancellable: Option<&impl IsA<gio::Cancellable>>) -> Result<(i32, u32), glib::Error> {
    ...
    //pub fn recv_messages_nonblocking(&self, stream_id: u32, component_id: u32, messages: /*Ignored*/Vec<InputMessage>, cancellable: Option<&impl IsA<gio::Cancellable>>) -> Result<(i32, u32), glib::Error> {
    ...
    //pub fn send_messages_nonblocking(&self, stream_id: u32, component_id: u32, messages: /*Ignored*/&[OutputMessage], cancellable: Option<&impl IsA<gio::Cancellable>>) -> Result<i32, glib::Error> {
    ...
    pub fn is_bytestream_tcp(&self) -> bool {
        glib::ObjectExt::property(self, "bytestream-tcp")
    }
    ...
    pub fn set_bytestream_tcp(&self, bytestream_tcp: bool) {
        glib::ObjectExt::set_property(self,"bytestream-tcp", bytestream_tcp)
    }

    pub fn compatibility(&self) -> u32 {
        glib::ObjectExt::property(self, "compatibility")
    }
    ...
    pub fn is_consent_freshness(&self) -> bool {
        glib::ObjectExt::property(self, "consent-freshness")
    }

    #[doc(alias = "controlling-mode")]
    pub fn is_controlling_mode(&self) -> bool {
        glib::ObjectExt::property(self, "controlling-mode")
    }

    #[doc(alias = "controlling-mode")]
    pub fn set_controlling_mode(&self, controlling_mode: bool) {
        glib::ObjectExt::set_property(self,"controlling-mode", controlling_mode)
    }
    ...
    pub fn is_force_relay(&self) -> bool {
        glib::ObjectExt::property(self, "force-relay")
    }
    ...
    pub fn set_force_relay(&self, force_relay: bool) {
        glib::ObjectExt::set_property(self,"force-relay", force_relay)
    }

    #[doc(alias = "full-mode")]
    pub fn is_full_mode(&self) -> bool {
        glib::ObjectExt::property(self, "full-mode")
    }
    ...
    pub fn is_ice_tcp(&self) -> bool {
        glib::ObjectExt::property(self, "ice-tcp")
    }
    ...
    pub fn set_ice_tcp(&self, ice_tcp: bool) {
        glib::ObjectExt::set_property(self,"ice-tcp", ice_tcp)
    }
    ...
    pub fn is_ice_trickle(&self) -> bool {
        glib::ObjectExt::property(self, "ice-trickle")
    }
    ...
    pub fn set_ice_trickle(&self, ice_trickle: bool) {
        glib::ObjectExt::set_property(self,"ice-trickle", ice_trickle)
    }
    ...
    pub fn is_ice_udp(&self) -> bool {
        glib::ObjectExt::property(self, "ice-udp")
    }
    ...
    pub fn set_ice_udp(&self, ice_udp: bool) {
        glib::ObjectExt::set_property(self,"ice-udp", ice_udp)
    }
    ...
    pub fn idle_timeout(&self) -> u32 {
        glib::ObjectExt::property(self, "idle-timeout")
    }
    ...
    pub fn set_idle_timeout(&self, idle_timeout: u32) {
        glib::ObjectExt::set_property(self,"idle-timeout", idle_timeout)
    }
    ...
    pub fn is_keepalive_conncheck(&self) -> bool {
        glib::ObjectExt::property(self, "keepalive-conncheck")
    }
    ...
    pub fn set_keepalive_conncheck(&self, keepalive_conncheck: bool) {
        glib::ObjectExt::set_property(self,"keepalive-conncheck", keepalive_conncheck)
    }

    //#[doc(alias = "main-context")]
    //pub fn main_context(&self) -> /*Unimplemented*/Basic: Pointer {
    //    glib::ObjectExt::property(self, "main-context")
    //}

    #[doc(alias = "max-connectivity-checks")]
    pub fn max_connectivity_checks(&self) -> u32 {
        glib::ObjectExt::property(self, "max-connectivity-checks")
    }

    #[doc(alias = "max-connectivity-checks")]
    pub fn set_max_connectivity_checks(&self, max_connectivity_checks: u32) {
        glib::ObjectExt::set_property(self,"max-connectivity-checks", max_connectivity_checks)
    }
    ...
    pub fn nomination_mode(&self) -> NominationMode {
        glib::ObjectExt::property(self, "nomination-mode")
    }
    ...
    //    glib::ObjectExt::property(self, "proxy-extra-headers")
    //}
    ...
    //    glib::ObjectExt::set_property(self,"proxy-extra-headers", proxy_extra_headers)
    //}

    #[doc(alias = "proxy-ip")]
    pub fn proxy_ip(&self) -> Option<glib::GString> {
        glib::ObjectExt::property(self, "proxy-ip")
    }

    #[doc(alias = "proxy-ip")]
    pub fn set_proxy_ip(&self, proxy_ip: Option<&str>) {
        glib::ObjectExt::set_property(self,"proxy-ip", proxy_ip)
    }

    #[doc(alias = "proxy-password")]
    pub fn proxy_password(&self) -> Option<glib::GString> {
        glib::ObjectExt::property(self, "proxy-password")
    }

    #[doc(alias = "proxy-password")]
    pub fn set_proxy_password(&self, proxy_password: Option<&str>) {
        glib::ObjectExt::set_property(self,"proxy-password", proxy_password)
    }

    #[doc(alias = "proxy-port")]
    pub fn proxy_port(&self) -> u32 {
        glib::ObjectExt::property(self, "proxy-port")
    }

    #[doc(alias = "proxy-port")]
    pub fn set_proxy_port(&self, proxy_port: u32) {
        glib::ObjectExt::set_property(self,"proxy-port", proxy_port)
    }

    #[doc(alias = "proxy-type")]
    pub fn proxy_type(&self) -> u32 {
        glib::ObjectExt::property(self, "proxy-type")
    }

    #[doc(alias = "proxy-type")]
    pub fn set_proxy_type(&self, proxy_type: u32) {
        glib::ObjectExt::set_property(self,"proxy-type", proxy_type)
    }

    #[doc(alias = "proxy-username")]
    pub fn proxy_username(&self) -> Option<glib::GString> {
        glib::ObjectExt::property(self, "proxy-username")
    }

    #[doc(alias = "proxy-username")]
    pub fn set_proxy_username(&self, proxy_username: Option<&str>) {
        glib::ObjectExt::set_property(self,"proxy-username", proxy_username)
    }

    pub fn is_reliable(&self) -> bool {
        glib::ObjectExt::property(self, "reliable")
    }
    ...
    pub fn stun_initial_timeout(&self) -> u32 {
        glib::ObjectExt::property(self, "stun-initial-timeout")
    }
    ...
    pub fn set_stun_initial_timeout(&self, stun_initial_timeout: u32) {
        glib::ObjectExt::set_property(self,"stun-initial-timeout", stun_initial_timeout)
    }
    ...
    pub fn stun_max_retransmissions(&self) -> u32 {
        glib::ObjectExt::property(self, "stun-max-retransmissions")
    }
    ...
    pub fn set_stun_max_retransmissions(&self, stun_max_retransmissions: u32) {
        glib::ObjectExt::set_property(self,"stun-max-retransmissions", stun_max_retransmissions)
    }

    #[doc(alias = "stun-pacing-timer")]
    pub fn stun_pacing_timer(&self) -> u32 {
        glib::ObjectExt::property(self, "stun-pacing-timer")
    }

    #[doc(alias = "stun-pacing-timer")]
    pub fn set_stun_pacing_timer(&self, stun_pacing_timer: u32) {
        glib::ObjectExt::set_property(self,"stun-pacing-timer", stun_pacing_timer)
    }
    ...
    pub fn stun_reliable_timeout(&self) -> u32 {
        glib::ObjectExt::property(self, "stun-reliable-timeout")
    }
    ...
    pub fn set_stun_reliable_timeout(&self, stun_reliable_timeout: u32) {
        glib::ObjectExt::set_property(self,"stun-reliable-timeout", stun_reliable_timeout)
    }

    #[doc(alias = "stun-server")]
    pub fn stun_server(&self) -> Option<glib::GString> {
        glib::ObjectExt::property(self, "stun-server")
    }

    #[doc(alias = "stun-server")]
    pub fn set_stun_server(&self, stun_server: Option<&str>) {
        glib::ObjectExt::set_property(self,"stun-server", stun_server)
    }

    #[doc(alias = "stun-server-port")]
    pub fn stun_server_port(&self) -> u32 {
        glib::ObjectExt::property(self, "stun-server-port")
    }

    #[doc(alias = "stun-server-port")]
    pub fn set_stun_server_port(&self, stun_server_port: u32) {
        glib::ObjectExt::set_property(self,"stun-server-port", stun_server_port)
    }

    #[doc(alias = "support-renomination")]
    pub fn supports_renomination(&self) -> bool {
        glib::ObjectExt::property(self, "support-renomination")
    }

    #[doc(alias = "support-renomination")]
    pub fn set_support_renomination(&self, support_renomination: bool) {
        glib::ObjectExt::set_property(self,"support-renomination", support_renomination)
    }

    pub fn is_upnp(&self) -> bool {
        glib::ObjectExt::property(self, "upnp")
    }

    pub fn set_upnp(&self, upnp: bool) {
        glib::ObjectExt::set_property(self,"upnp", upnp)
    }

    #[doc(alias = "upnp-timeout")]
    pub fn upnp_timeout(&self) -> u32 {
        glib::ObjectExt::property(self, "upnp-timeout")
    }

    #[doc(alias = "upnp-timeout")]
    pub fn set_upnp_timeout(&self, upnp_timeout: u32) {
        glib::ObjectExt::set_property(self,"upnp-timeout", upnp_timeout)
    }

    #[doc(alias = "candidate-gathering-done")]
    pub fn connect_candidate_gathering_done<F: Fn(&Self, u32) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_component_state_changed<F: Fn(&Self, u32, u32, u32) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_initial_binding_request_received<F: Fn(&Self, u32) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_new_candidate<F: Fn(&Self, u32, u32, &str) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_new_candidate_full<F: Fn(&Self, &Candidate) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_new_remote_candidate<F: Fn(&Self, u32, u32, &str) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_new_remote_candidate_full<F: Fn(&Self, &Candidate) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_new_selected_pair<F: Fn(&Self, u32, u32, &str, &str) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_new_selected_pair_full<F: Fn(&Self, u32, u32, &Candidate, &Candidate) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_reliable_transport_writable<F: Fn(&Self, u32, u32) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_8")))]
    #[doc(alias = "bytestream-tcp")]
    pub fn connect_bytestream_tcp_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "controlling-mode")]
    pub fn connect_controlling_mode_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_14")))]
    #[doc(alias = "force-relay")]
    pub fn connect_force_relay_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_8")))]
    #[doc(alias = "ice-tcp")]
    pub fn connect_ice_tcp_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_16")))]
    #[doc(alias = "ice-trickle")]
    pub fn connect_ice_trickle_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_8")))]
    #[doc(alias = "ice-udp")]
    pub fn connect_ice_udp_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_17")))]
    #[doc(alias = "idle-timeout")]
    pub fn connect_idle_timeout_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_8")))]
    #[doc(alias = "keepalive-conncheck")]
    pub fn connect_keepalive_conncheck_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "max-connectivity-checks")]
    pub fn connect_max_connectivity_checks_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_20")))]
    #[doc(alias = "proxy-extra-headers")]
    pub fn connect_proxy_extra_headers_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_proxy_extra_headers_trampoline<F: Fn(&Agent) + Send + Sync + 'static>(this: *mut ffi::NiceAgent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::proxy-extra-headers\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_proxy_extra_headers_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "proxy-ip")]
    pub fn connect_proxy_ip_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "proxy-password")]
    pub fn connect_proxy_password_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "proxy-port")]
    pub fn connect_proxy_port_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "proxy-type")]
    pub fn connect_proxy_type_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "proxy-username")]
    pub fn connect_proxy_username_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_15")))]
    #[doc(alias = "stun-initial-timeout")]
    pub fn connect_stun_initial_timeout_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_15")))]
    #[doc(alias = "stun-max-retransmissions")]
    pub fn connect_stun_max_retransmissions_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "stun-pacing-timer")]
    pub fn connect_stun_pacing_timer_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_1_15")))]
    #[doc(alias = "stun-reliable-timeout")]
    pub fn connect_stun_reliable_timeout_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "stun-server")]
    pub fn connect_stun_server_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "stun-server-port")]
    pub fn connect_stun_server_port_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "support-renomination")]
    pub fn connect_support_renomination_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "upnp")]
    pub fn connect_upnp_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "upnp-timeout")]
    pub fn connect_upnp_timeout_notify<F: Fn(&Self) + Send + Sync + 'static>(&self, f: F) -> SignalHandlerId {
